...
Windows 上的 Codex 任务完成语音播报插件。每当 Codex 结束一个代理回合，它会先播放提示音，再用可切换的中文神经语音播报当前项目名称，例如“本地设备项目已完成”。
...
Codex 当前提供的是 `agent-turn-complete` 通知，而不是业务结果的“成功”事件。因此，最终回复、澄清问题和阻塞报告都可能触发播报。
